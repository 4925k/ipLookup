...
//this package helps to faltten nested structs to flat struct
//the lookups respond with nested lookups
//the main program uses map[string]string
//the package helps to convert them
//it has been tweaked to return map[string]string
package flatten
